...
the logistic model.
In particular, the decision tree is very poor at making
correct predictions for low values of specificity.
So if we are willing to accept a high rate of
false positives, the logistic model may be a better choice.
...
yields sensitivity values comparable to those
of the logistic model
if we accept a specificity of around 70 \% - 100 \%.
Perhaps a decision tree based on the Information gain
splitting method would yield a better AUC value.
