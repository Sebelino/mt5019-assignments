...
square_statistics2d
```
The P-value is approximately 3.3 \% which is less than 5 \%. Hence, the result is statistically significant.

Given that the odds ratio is so close to 1, it may not be practically significant even though it is statistically significant So this result may not be relevant.

This result could be expressed using for example a forest plot, a bar plot of the relative frequencies, or a confidence interval for the odds ratio.
